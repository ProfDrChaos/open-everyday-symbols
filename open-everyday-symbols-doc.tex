...
\begin{center}
  \texttt{\string\everydaySymbol[some-color]$\{\textit{main-category}\}\{\textit{sub-identifier-number}\}$}
\end{center}
...
\begin{itemize}
  ...
  \item \verb|\everydaySymbol[blue]{snow}{snowflake--john-01}| \dotfill\ \everydaySymbol[blue]{snow}{snowflake--john-01}
\end{itemize}
