...
\begin{itemize}
  ...
  \item \emph{z} is increased whenever a subcategory (like ``floorplan'') is added. If multiple subcategories are added at once, the number still only increases once. If main a category is added on top of a subcategory, the main category takes precedence.
