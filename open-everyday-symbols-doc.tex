...
Also, unlike the other symbols, symbols in this figure will automatically to the font size used, {\large like \everydaySymbol[color=blue]{snow}{snowflake--john-01} this} {\tiny as opposed \everydaySymbol[color=blue]{snow}{snowflake--john-01} to this} (notice the size of the flakes).
